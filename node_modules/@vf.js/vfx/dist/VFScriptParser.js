...
var VFScriptParser = /** @class */ (function () {
    ...
    VFScriptParser.prototype.splitWord = function (scriptStr) {
        ...
        for (var i = 0, len = scriptStr.length; i < len; i++) {
            ...
            else if (slashNumber === 1 && char !== VFS_Keyword.Slash) {
                slashNumber = 0;
            }
            // 处理引号
    ...
    VFScriptParser.prototype.parseArrayRandom = function (tokens) {
        ...
        var express = [ExpressItemType.VARIABLE];
        var target = [];
        var i = 0;
        var len = 0;
    ...
    VFScriptParser.prototype.parseComponentExpress = function (tokens) {
        var express = [ExpressItemType.COMPONENT];
        var target = [];
        var i = 0;
        var len = 0;
        for (i = 0, len = tokens.length; i < len; i++) {
    ...
    VFScriptParser.prototype.parseProperty = function (tokens) {
        var express = [ExpressItemType.PROPERTY];
        var target = [];
        var i = 0;
        var len = 0;
        for (i = 0, len = tokens.length; i < len; i++) {
    ...
    VFScriptParser.prototype.parseArrayIndex = function (tokens) {
        var express = [ExpressItemType.ARRAY_VALUE];
        var target = [];
        var arrIndexItems = [];
        var i = 0;
        var len = 0;
    ...
    VFScriptParser.prototype.parseArrayLength = function (tokens) {
        var express = [ExpressItemType.ARRAY_LEN];
        var target = [];
        var i = 0;
        var len = 0;
        for (i = 0, len = tokens.length; i < len; i++) {
    ...
    VFScriptParser.prototype.parseArrayFunction = function (tokens) {
        var express = [ExpressItemType.ARRAY_FUNCTION];
        var target = [];
        var params = [];
        var funName = '';
        var i = 0;
